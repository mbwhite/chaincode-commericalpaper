...
const {CommercialPaper} = require('./cpstate.js');
const {CommericalPaperContext} = reqiure('./cpcontext.js')
...
class CommercialPaperContract extends Contract {
    ...
    /**
     * Creates a custom context that has the support for commerical paper
     */
    createContext(){
